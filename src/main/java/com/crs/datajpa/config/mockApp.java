...
public class mockApp implements ApplicationRunner {
    ...
    mockApp(CategoryRepository categoryRepository, CustomerRepository customerRepository, AddressRepository addressRepository, CartRepository cartRepository, CartItemRepository cartItemRepository, ProductRepository productRepository, OrderRepository orderRepository, OrderItemRepository orderItemRepository, PaymenteRepository paymenteRepository, InvoiceRepository invoiceRepository) {
